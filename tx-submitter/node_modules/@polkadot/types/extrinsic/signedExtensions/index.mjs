...
import polkadotExtensions from "./polkadot.mjs";
import substrateExtensions from "./substrate.mjs"; // A mapping of the known signed extensions to the extra fields that they contain. Unlike in the actual extensions,
...
const allExtensions = _objectSpread(_objectSpread({}, substrateExtensions), polkadotExtensions); // the v4 signed extensions (the order is important here, as applied by default)
