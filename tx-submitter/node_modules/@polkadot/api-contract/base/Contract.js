...
function createWithId(fn) {
  return (messageOrId, options, ...params) => (0, _util2.isOptions)(options) ? fn(messageOrId, options, params) : fn(messageOrId, ...(0, _util2.extractOptions)(options, params));
}
  ...
  constructor(api, abi, address, decorateMethod) {
    ...
    Object.defineProperty(this, _getGas, {
      ...
      value: (_gasLimit, isCall = false) => {
        ...
        return gasLimit.lten(0) ? isCall ? MAX_CALL_GAS : this.api.consts.system.maximumBlockWeight.muln(64).divn(100) : gasLimit;
      }
    });
    Object.defineProperty(this, _exec, {
      ...
      value: (messageOrId, {
        ...
        return this.api.tx.contracts.call(this.address, value, (0, _classPrivateFieldLooseBase2.default)(this, _getGas)[_getGas](gasLimit), this.abi.findMessage(messageOrId).toU8a(params)).withResultTransform(result => new ContractSubmittableResult(result, (0, _util2.applyOnEvent)(result, 'ContractExecution', records => records.map(({
          event: {
            data: [, data]
          }
        }) => {
    ...
    this.exec = createWithId((0, _classPrivateFieldLooseBase2.default)(this, _exec)[_exec]);
    this.read = createWithId((0, _classPrivateFieldLooseBase2.default)(this, _read)[_read]);
