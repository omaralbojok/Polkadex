...
var _MetaRegistry = require("./MetaRegistry");
...
function findMessage(list, messageOrId) {
  ...
  return (0, _util.assertReturn)(message, `Attempted to call an invalid contract interface, ${JSON.stringify(messageOrId)}`);
}

var _events = (0, _classPrivateFieldLooseKey2.default)("events");

var _createArgs = (0, _classPrivateFieldLooseKey2.default)("createArgs");

var _createEvent = (0, _classPrivateFieldLooseKey2.default)("createEvent");

var _createMessage = (0, _classPrivateFieldLooseKey2.default)("createMessage");

var _decodeArgs = (0, _classPrivateFieldLooseKey2.default)("decodeArgs");

var _decodeMessage = (0, _classPrivateFieldLooseKey2.default)("decodeMessage");

var _encodeArgs = (0, _classPrivateFieldLooseKey2.default)("encodeArgs");
...
class Abi {
  constructor(abiJson, chainProperties) {
    ...
    Object.defineProperty(this, _createMessage, {
      ...
      value: (spec, index, add = {}) => {
        ...
        const message = _objectSpread(_objectSpread({}, add), {}, {
          ...
          toU8a: (params, additional) => (0, _classPrivateFieldLooseBase2.default)(this, _encodeArgs)[_encodeArgs](spec, args, params, additional)
        });
    ...
    this.json = json;
    this.registry = new _MetaRegistry.MetaRegistry(chainProperties);
