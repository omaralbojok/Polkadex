...
class MetaRegistry extends _create.TypeRegistry {
  constructor(chainProperties) {
    ...
    Object.defineProperty(this, _extract, {
      ...
      value: (type, id) => {
        ...
        return (0, _create.withTypeString)(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, displayName ? {
          displayName
        } : {}), path.length > 1 ? {
    ...
    Object.defineProperty(this, _extractVariantSub, {
      ...
      value: variants => {
        ...
        return variants.map(({
          fields,
          name
        }) => (0, _create.withTypeString)(_objectSpread(_objectSpread({}, (0, _classPrivateFieldLooseBase2.default)(this, _extractFields)[_extractFields](fields)), {}, {
          name: name.toString()
        })));
      }
    });
