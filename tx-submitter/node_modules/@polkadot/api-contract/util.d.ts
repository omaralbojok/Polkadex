...
declare type ContractEvents = 'CodeStored' | 'ContractExecution' | 'Instantiated';
...
export declare function applyOnEvent<T>(result: SubmittableResult, type: ContractEvents, fn: (records: EventRecord[]) => T): T | undefined;
