...
function bounties(instanceId, api) {
  ...
  return (0, _util.memo)(instanceId, () => (0, _xRxjs.combineLatest)([bountyBase.bountyCount(), api.query.council.proposalCount()]).pipe((0, _operators.switchMap)(() => (0, _xRxjs.combineLatest)([bountyBase.bounties.keys(), api.derive.council.proposals()])), (0, _operators.switchMap)(([keys, proposals]) => {
    const ids = keys.map(({
      args: [id]
    }) => id);
