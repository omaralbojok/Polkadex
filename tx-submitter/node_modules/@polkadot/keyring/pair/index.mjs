...
export function createPair({
  ...
  return {
    ...
    sign: (message, options = {}) => {
      ...
      return u8aConcat(options.withType ? TYPE_PREFIX[type] : SIG_TYPE_NONE, TYPE_SIGNATURE[type](message, {
        publicKey,
        secretKey
      }));
    },
    ...
    verify: (message, signature) => signatureVerify(message, signature, TYPE_ADDRESS[type](publicKey)).isValid
  };
}