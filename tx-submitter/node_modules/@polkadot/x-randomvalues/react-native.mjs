...
import { insecureRandomValues } from "./fallback.mjs";
...
export const getRandomValues = typeof global.crypto === 'object' && typeof global.crypto.getRandomValues === 'function' ? getRandomValuesGlobal // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access,@typescript-eslint/no-explicit-any
: typeof global.nativeCallSyncHook === 'undefined' || !NativeModules.ExpoRandom ? insecureRandomValues : getRandomValuesNative;